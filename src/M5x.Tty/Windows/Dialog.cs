...
namespace M5x.Tty.Windows
{
    ...
    ///     one
    ///     or more <see cref="Button" />s. It defaults to the <see cref="Colors.Dialog" /> color scheme and has a 1 cell
    ...
    public class Dialog : Window
    {
        ...
        ///     After initialzation use <c>X</c>, <c>Y</c>, <c>Width</c>, and <c>Height</c> to override this with a location or
        ///     size.
        /// </remarks>
        /// <remarks>
        ...
        /// <remarks>
        ///     <para>
        ///         Te Dialog will be vertically and horizontally centered in the container and the size will be 85% of the
        ///         container.
        ///         After initialzation use <c>X</c>, <c>Y</c>, <c>Width</c>, and <c>Height</c> to override this with a location or
        ///         size.
        ///     </para>
        ...
        ///     </para>
        /// </remarks>
        public Dialog() : this(string.Empty, 0, 0, null)
        {
        }
        ...
        ///     size.
        /// </remarks>
        public Dialog(ustring title, params Button[] buttons) : this(title, 0, 0, buttons)
        {
        }
