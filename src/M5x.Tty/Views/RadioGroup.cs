...
namespace M5x.Tty.Views
{
    ...
    public class RadioGroup : View
    {
        ...
        private List<ustring> radioLabels = new();
        ...
        /// </summary>
        public RadioGroup() : this(new ustring[] { })
        {
        }
        ...
        /// <summary>
        ///     Gets or sets the horizontal space for this <see cref="RadioGroup" /> if the <see cref="DisplayMode" /> is
        ///     <see cref="DisplayModeLayout.Horizontal" />
        /// </summary>
        ...
        private void Init(Rect rect, ustring[] radioLabels, int selected)
        {
            if (radioLabels == null)
        ...
        private void SetWidthHeight(List<ustring> radioLabels)
        {
            switch (displayMode)
            {
        ...
        private static Rect MakeRect(int x, int y, List<ustring> radioLabels)
        {
            var width = 0;

            if (radioLabels == null) return new Rect(x, y, width, 0);
        ...
        public override void Redraw(Rect bounds)
        {
            ...
            for (var i = 0; i < radioLabels.Count; i++)
            {
                ...
                Driver.SetAttribute(ColorScheme.Normal);
                Driver.AddStr(ustring.Make(new[] {i == selected ? Driver.Selected : Driver.UnSelected, ' '}));
