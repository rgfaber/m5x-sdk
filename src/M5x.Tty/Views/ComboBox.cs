...
namespace M5x.Tty.Views
{
    ...
    public class ComboBox : View
    {
        ...
        private readonly int minimumHeight = 2;
        private readonly TextField search;
        private bool autoHide = true;

        private bool isShow;

        private IList searchset;
        ...
        private void Initialize()
        {
            ...
            listview.OpenSelectedItem += a => Selected();
        ...
        private int CalculatetHeight()
        {
            ...
            return Math.Min(Math.Max(Bounds.Height - 1, minimumHeight - 1),
