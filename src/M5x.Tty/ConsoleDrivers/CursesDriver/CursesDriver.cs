...
namespace M5x.Tty.ConsoleDrivers.CursesDriver
{
    ...
    internal class CursesDriver : ConsoleDriver
    {
        ...
        private readonly Dictionary<int, int> rawPairs = new();
        ...
        {
            Curses.refresh();
            if (Curses.CheckWinChange()) TerminalResized?.Invoke();
        }
                    ...
                    Task.Run(async () =>
                    {
                        while (IsButtonPressed && LastMouseButtonPressed != null)
                        {
                            ...
                            if (IsButtonPressed && LastMouseButtonPressed != null &&
                                (mouseFlag & MouseFlags.ReportMousePosition) == 0) mouseHandler(me);
        ...
        private void ProcessInput(Action<KeyEvent> keyHandler, Action<KeyEvent> keyDownHandler,
        ...
        public override void Init(Action terminalResized)
        {
            ...
            reportableMouseEvents = Curses.mousemask(Curses.Event.AllEvents | Curses.Event.ReportMousePosition,
                out oldMouseEvents);
        ...
        public override Attribute MakeAttribute(Color fore, Color back)
        {
            ...
            return MakeColor((short) (f & 0xffff), (short) MapColor(back)) |
                   ((f & Curses.A_BOLD) != 0 ? Curses.A_BOLD : 0);
        }
