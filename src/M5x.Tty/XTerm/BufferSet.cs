...
namespace M5x.Tty.XTerm
{
    ...
    public class BufferSet
    {
        ...
        {
            Normal = new Buffer(terminal);
            Normal.FillViewportRows();

            // The alt buffer should never have scrollback.
            // See http://invisible-island.net/xterm/ctlseqs/ctlseqs.html#h2-The-Alternate-Screen-Buffer
            Alt = new Buffer(terminal, false);

            Active = Normal;
            SetupTabStops();
        }

        public Buffer Normal { get; }
        public Buffer Alt { get; }
        ...
        /// <summary>
        ///     Raised when a buffer is activated, the parameters is the buffer that was activated and the second parameter is the
        ///     Inactive buffer.
        /// </summary>
