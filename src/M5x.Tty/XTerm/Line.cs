...
namespace M5x.Tty.XTerm
{
    ...
    public class Line
    {
        ...
        public int StartLine
        {
            get
            {
                if (fragments.Count > 0) return fragments[0].Line;
        ...
        public int StartLocation
        {
            get
            {
                if (fragments.Count > 0) return fragments[0].Location;
        ...
        {
            foreach (var fragment in fragments) builder.Append(fragment.Text);
        }
