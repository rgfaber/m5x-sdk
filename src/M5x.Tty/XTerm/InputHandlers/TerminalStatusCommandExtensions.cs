...
namespace M5x.Tty.XTerm.InputHandlers
{
    ...
    internal static class TerminalStatusCommandExtensions
    {
        ...
        public static void csiDA1(this Terminal terminal, int[] pars, string collect)
        {
            ...
            if (collect == "")
            {
                if (name.StartsWith("xterm", StringComparison.Ordinal) ||
                    name.StartsWith("rxvt-unicode", StringComparison.Ordinal) ||
                    name.StartsWith("screen", StringComparison.Ordinal))
            ...
            else if (collect == ">")
            {
                ...
                else if (name.StartsWith("linux", StringComparison.Ordinal)) // not supported by linux console.
        ...
        public static void csiDSR(this Terminal terminal, int[] pars, string collect)
        {
            ...
            else if (collect == "?") // modern xterm doesnt seem to
