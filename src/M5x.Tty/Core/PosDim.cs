...
namespace M5x.Tty.Core
{
    ...
    public class Pos
    {
        ...
        {
            return new PosCombine(true, new PosView(view, 0), new PosAbsolute(0));
        }
        ...
        {
            return new PosCombine(true, new PosView(view, 1), new PosAbsolute(0));
        }
        ...
        {
            return new PosCombine(true, new PosView(view, 2), new PosAbsolute(0));
        }
        ...
        {
            return new PosCombine(true, new PosView(view, 3), new PosAbsolute(0));
        }
        ...
        internal class PosAbsolute : Pos
        {
            ...
            {
                return other is PosAbsolute abs && abs.n == n;
            }
        }
        ...
        private class PosCombine : Pos
        {
            ...
            public override string ToString()
            {
                return $"Pos.Combine({left}{(add ? '+' : '-')}{right})";
            }
        }
        ...
        internal class PosView : Pos
        {
            ...
            public override string ToString()
            {
                ...
                return $"Pos.View(side={tside}, target={Target})";
            }
        }
    }
    ...
    public class Dim
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="Dim" /> class that fills the dimension, but leaves the specified
        ///     number of colums for a margin.
        /// </summary>
        ...
        public override bool Equals(object other)
        {
            return other is Dim abs && abs == this;
        }
        ...
        internal class DimAbsolute : Dim
        {
            ...
            public override bool Equals(object other)
            {
                return other is DimAbsolute abs && abs.n == n;
            }
        }
        ...
        internal class DimFill : Dim
        {
            ...
            public override int GetHashCode()
            {
                return margin.GetHashCode();
            }

            public override bool Equals(object other)
            {
                return other is DimFill fill && fill.margin == margin;
            }
        }
        ...
        internal class DimCombine : Dim
        {
            ...
            public override string ToString()
            {
                return $"Dim.Combine({left}{(add ? '+' : '-')}{right})";
            }
        }
        ...
        internal class DimView : Dim
        {
            ...
            public override bool Equals(object other)
            {
                return other is DimView abs && abs.Target == Target;
            }
        }
    }
}