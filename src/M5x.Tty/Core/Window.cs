...
{
    /// <summary>
    ///     A <see cref="Toplevel" /> <see cref="View" /> that draws a border around its <see cref="View.Frame" /> with a
    ///     <see cref="Title" /> at the top.
    /// </summary>
    /// <remarks>
    ///     The 'client area' of a <see cref="Window" /> is a rectangle deflated by one or more rows/columns from
    ///     <see cref="View.Bounds" />. A this time there is no
    ...
    public class Window : Toplevel
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="Window" /> class with an optional title using
        ///     <see cref="LayoutStyle.Absolute" /> positioning.
        /// </summary>
        /// <param name="frame">Superview-relative rectangle specifying the location and size</param>
        /// <param name="title">Title</param>
        /// <remarks>
        ///     This constructor intitalizes a Window with a <see cref="LayoutStyle" /> of <see cref="LayoutStyle.Absolute" />. Use
        ///     constructors
        ...
        ///     Use <see cref="View.X" />, <see cref="View.Y" />, <see cref="View.Width" />, and <see cref="View.Height" />
        ///     properties to dynamically control the size and location of the view.
        /// </remarks>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="Window" /> using <see cref="LayoutStyle.Absolute" /> positioning with
        ///     the specified frame for its location, with the specified frame padding,
        ...
        ///     This constructor intitalizes a Window with a <see cref="LayoutStyle" /> of <see cref="LayoutStyle.Absolute" />. Use
        ///     constructors
        ///     that do not take <c>Rect</c> parameters to initialize a Window with  <see cref="LayoutStyle" /> of
        ...
        public override void Remove(View view)
        {
            ...
            if (contentView.InternalSubviews.Count < 1) CanFocus = false;
