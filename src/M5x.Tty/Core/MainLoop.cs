...
namespace M5x.Tty.Core
{
    ...
    {
        internal List<Func<bool>> idleHandlers = new();

        private bool running;

        internal SortedList<long, Timeout> timeouts = new();
        ...
        /// <summary>
        ///     Adds specified idle handler function to mainloop processing. The handler function will be called once per iteration
        ///     of the main loop after other events have been handled.
        /// </summary>
        /// <remarks>
        ///     <para>
        ...
        ///     </para>
        /// </remarks>
        /// <param name="idleHandler">
        ///     Token that can be used to remove the idle handler with <see cref="RemoveIdle(Func{bool})" />
        ///     .
        /// </param>
