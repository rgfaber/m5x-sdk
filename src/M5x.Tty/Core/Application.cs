...
namespace M5x.Tty.Core
{
    ...
    public static class Application
    {
        ...
        private static readonly Stack<Toplevel> toplevels = new();
        ...
        /// <summary>
        ///     The current <see cref="Toplevel" /> object. This is updated when <see cref="Application.Run()" /> enters and leaves
        ///     to point to the current <see cref="Toplevel" /> .
        /// </summary>
        ...
        {
            return new(new Point((Driver.Cols - size.Width) / 2, (Driver.Rows - size.Height) / 2), size);
        }
        ...
        {
            Init(() => Toplevel.Create(), driver, mainLoopDriver);
        }

        /// <summary>
        ///     Initializes the Terminal.Gui application
        /// </summary>
        private static void Init(Func<Toplevel> topLevelFactory, ConsoleDriver driver = null,
...
//#endif
        ...
        private static bool OutsideFrame(Point p, Rect r)
        {
        ...
        /// <summary>
        ///     Runs the application by calling <see cref="Run(Toplevel)" /> with a new instance of the specified
        ...
        ///     </para>
        ///     <para>
        ///         Calling <see cref="Run(Toplevel)" /> is equivalent to calling <see cref="Begin(Toplevel)" />, followed by
        ///         <see cref="RunLoop(RunState, bool)" />,
        ...
        ///         the <see cref="RunLoop(RunState, bool)" /> method will only process any pending events, timers, idle handlers
        ///         and
        ...
        ///         property on the curently running <see cref="Toplevel" /> to false.
        ///     </para>
        /// </remarks>
        ...
        public class RunState : IDisposable
        {
            ...
            /// </summary>
            /// <remarks>
            ///     Call <see cref="Dispose()" /> when you are finished using the <see cref="Application.RunState" />. The
