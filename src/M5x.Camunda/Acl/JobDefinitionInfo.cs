namespace M5x.Camunda.Acl
{
    public class JobDefinitionInfo
    {
        ...
        /// <summary>
        ///     The configuration of a job definition provides details about the jobs which will be created, for example: for timer
        ///     jobs it is the timer configuration.
        /// </summary>
        ...
        /// <summary>
        ///     The execution priority defined for jobs that are created based on this definition. May be null when the priority
        ///     has not been overridden on the job definition level.
        /// </summary>
