...
public class BatchInfo
{
    ...
    ///     The batch seed job is invoked until it has created all batch execution jobs required by the batch (see
    ///     <see cref="TotalJobs" /> property).
    /// </summary>
    ...
    ///     E.g., for a process instance migration batch this specifies the number of process instances which are migrated per
    ///     batch execution job.
    /// </summary>
