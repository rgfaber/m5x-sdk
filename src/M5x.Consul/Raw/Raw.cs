...
namespace M5x.Consul.Raw
{
    ...
    public class Raw : IRawEndpoint
    {
        ...
        internal Raw(ConsulClient.ConsulClient c)
        {
            _client = c;
        }

        /// <summary>
        ///     Query is used to do a GET request against an endpoint and deserialize the response into an interface using standard
        ///     Consul conventions.
        /// </summary>
        ...
        /// <summary>
        ///     Write is used to do a PUT request against an endpoint and serialize/deserialized using the standard Consul
        ///     conventions.
        /// </summary>
        /// <param name="endpoint">The URL endpoint to access</param>
        /// <param name="obj">
        ///     The object to serialize and send to the endpoint. Must be able to be JSON serialized, or be an object
        ///     of type byte[], which is sent without serialzation.
        /// </param>
