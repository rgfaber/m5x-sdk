...
namespace M5x.Consul.Tests
{
    ...
    {
        private static readonly AsyncReaderWriterLock m_Lock = new();

        internal static Task<AsyncReaderWriterLock.Releaser> Parallel()
        {
            return m_Lock.ReaderLockAsync();
        }

        internal static Task<AsyncReaderWriterLock.Releaser> NoParallel()
        {
