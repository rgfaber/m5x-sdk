...
{
    public class SessionTest : ConsulTestsBase, IDisposable
    {
        public SessionTest(ITestOutputHelper output, IoCTestContainer container) : base(output, container)
        {
        }
        ...
        public async Task Session_Create_RenewPeriodic_TtlExpire()
        {
            ...
            {
                foreach (var e in ae.InnerExceptions) Assert.IsType<SessionExpiredException>(e);
                return;
            }
